...
server.get('/', (req, res) => {
    res.send('<h3>Facturen</h3><br><p>De server is succesvol gestart.</p><br><p>Ga naar <a href="http://api.owencoenraad.nl/facturen" target="_blank"><strong>api.owencoenraad.nl/facturen</strong></a> om te testen.</p>');
});
